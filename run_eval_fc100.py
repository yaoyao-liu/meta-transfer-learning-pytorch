...
def run_exp(num_batch=1000, shot=1, query=15, lr=0.0001, lr2=0.001, lr3=0.00001, base_lr=0.01, update_step=10, gamma=0.5):
    ...
    gpu = 2
    label = 'exp6'
    eval_weights = '/BS/sun_project_multimodal/work/yyliu_project/lcc-new/Mtl-PyTorch-12-0-0/logs/meta/FC100_ResNet_MTL_shot1_way5_query15_step10_gamma0.5_lr0.0001_lr20.001_lr31e-05_batch100_maxepoch100_baselr0.01_updatestep100_stepsize10_exp6/max_acc.pth'
